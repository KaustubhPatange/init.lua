...
if is_available "vim-fugitive" then maps.n["<leader>gL"] = { "<cmd>Git blame<cr>", desc = "View file Git blame" } end
...
-- TreeHopper
if is_available "nvim-treehopper" then
  maps.n["<leader>lt"] = { function() require("tsht").nodes() end, desc = "Treehopper" }
end
